def main():
    ...
    OSESMO_Git_Repo_Directory = '/home/cwbarclift/code/personal/switch_suncode2019/api_server/switch_api/services/osemo/Code'
    ...
    Input_Output_Data_Directory_Location = '/home/cwbarclift/code/personal/switch_suncode2019/api_server/switch_api/services/osemo'
    ...
    Load_Profile_Name_Input = "Suncode_2019_Load_Profile_Vector"

    # Retail Rate Name
    # Name of the selected retail rate.
    Retail_Rate_Name_Input = "PG&E E-TOU-B"
    ...
    Solar_Profile_Name_Input = "Suncode_2019_PVWatts_Vector"
    ...
    from switch_api.services.osemo.Code.Solar_Installed_Cost_per_kW_Calculator_SC2019 import Solar_Installed_Cost_per_kW_Calculator
    ...
    from switch_api.services.osemo.Code.Storage_Installed_Cost_per_kWh_Calculator_SC2019 import Storage_Installed_Cost_per_kWh_Calculator
    ...
    from switch_api.services.osemo.Code.OSESMO_SC2019 import OSESMO

    Storage_Dispatch_Profile = OSESMO(Modeling_Team_Input, Model_Run_Number_Input, Model_Type_Input,
    ...
    return Storage_Dispatch_Profile
