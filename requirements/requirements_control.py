# Generate the Anaconda requirements files for the current environment.
...
def generate():
    ...
    os.system(f"conda env export --name $CONDA_DEFAULT_ENV --file conda_environment_{platform}.txt")
...
def install_environment():
    os.system(f"conda env create --file conda_environment_{platform}.txt")
